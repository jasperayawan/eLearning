...
<header class="sticky-top w-100 header" id="header">
    ...
    <div class="form-body container-fluid">
                <form autocomplete="off" method="post" id="login_form">
                    <div class="mb-2">
                    ...
                    <input type="submit" value="Login" class="btn w-100 mb-2" onclick="submitData()" id="registerBtn"/>
                    <div class="text-end">
                        <span>Do not have an account? <a href="./signup.php">Register here!</a></span>
                    </div>
                </form>
    </div>
