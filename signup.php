...
<header class="sticky-top w-100 header" id="header">
    ...
    <div class="form-body container-fluid">
            <form autocomplete="off" method="post" id="register_form">
                    <div class="mb-2">
                        <input type="hidden" id="action" value="register">
                        <label for="text" class="col-form-label">Full Name</label>
                    ...
                    <input type="submit" value="Register" class="btn w-100 mb-2" onclick="submitData()" id="registerBtn"/>
                    <div class="text-end">
